...
T{
    CROSS PIECE-NUMBER 0 2 3 PIECE-KEY BINARY 1000011010 ?S DECIMAL
    UPPERI PIECE-NUMBER 1 7 7 PIECE-KEY BINARY 10011111110000000000 ?S DECIMAL
}T
."    creating a board value from a piece" CR
T{
    CROSS PIECE-NUMBER 0 0 0 PIECE-BOARD BINARY 000000100000011100000010 ?S DECIMAL
    UPPERI PIECE-NUMBER 0 0 0 PIECE-BOARD BINARY 11111 ?S DECIMAL
    UPPERI PIECE-NUMBER 1 0 0 PIECE-BOARD BINARY 100000001000000010000000100000001 ?S DECIMAL
}T
BYE
